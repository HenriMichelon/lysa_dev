...
function(compile_shader EXTENSION PROFILE ENTRY_POINT SHADER_SOURCE SHADER_BINARIES SHADER_INCLUDE_DIR GLOBAL_SHADER_INCLUDE_DIR)
    set(LOCAL_COMMANDS)
    set(LOCAL_PRODUCTS)
    if (DIRECTX_BACKEND)
        ...
        list(APPEND LOCAL_COMMANDS "-I")
        list(APPEND LOCAL_COMMANDS "${GLOBAL_SHADER_INCLUDE_DIR}")
...
function(compile_shaders TARGET_NAME BUILD_DIR SHADER_INCLUDE_DIR GLOBAL_SHADER_INCLUDE_DIR)
    ...
    foreach(SHADER_SOURCE IN LISTS SHADER_SOURCE_FILES)
        ...
        if(SHADER_SOURCE MATCHES ".comp.slang$")
            compile_shader("comp" "cs_6_6" "main" ${SHADER_SOURCE} ${SHADER_BINARIES} ${SHADER_INCLUDE_DIR} ${GLOBAL_SHADER_INCLUDE_DIR})
        elseif (SHADER_SOURCE MATCHES ".hull.slang$")
            compile_shader("hull" "hs_6_6" "main" ${SHADER_SOURCE} ${SHADER_BINARIES} ${SHADER_INCLUDE_DIR} ${GLOBAL_SHADER_INCLUDE_DIR})
        elseif (SHADER_SOURCE MATCHES ".domain.slang$")
            compile_shader("domain" "ds_6_6" "main" ${SHADER_SOURCE} ${SHADER_BINARIES} ${SHADER_INCLUDE_DIR} ${GLOBAL_SHADER_INCLUDE_DIR})
        elseif (SHADER_SOURCE MATCHES ".geom.slang$")
            compile_shader("domain" "gs_6_6" "main" ${SHADER_SOURCE} ${SHADER_BINARIES} ${SHADER_INCLUDE_DIR} ${GLOBAL_SHADER_INCLUDE_DIR})
        elseif (SHADER_SOURCE MATCHES ".vert.slang$")
            compile_shader("vert" "vs_6_6" "vertexMain" ${SHADER_SOURCE} ${SHADER_BINARIES} ${SHADER_INCLUDE_DIR} ${GLOBAL_SHADER_INCLUDE_DIR})
        elseif (SHADER_SOURCE MATCHES ".frag.slang$")
            compile_shader("frag" "ps_6_6" "fragmentMain" ${SHADER_SOURCE} ${SHADER_BINARIES} ${SHADER_INCLUDE_DIR} ${GLOBAL_SHADER_INCLUDE_DIR})
